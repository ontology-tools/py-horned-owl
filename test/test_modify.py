...
def test_add_collect_all_axioms():
    o = simple_ontology()
    ...
    expected = {*axioms, AnnotatedComponent(axiom)}
    actual = set(o.get_axioms())

    assert expected == actual


def test_add_collect_by_iri():
    o = simple_ontology()
...
def test_remove_collect_all_axioms():
    o = simple_ontology()
...
def test_remove_collect_by_iri():
    o = simple_ontology()

    all_axioms = set(o.get_axioms())
    axioms = set(o.get_components_for_iri(":A"))
    axiom = SubClassOf(o.clazz(":B"), o.clazz(":A"))
    ann_axiom = AnnotatedComponent(axiom)
