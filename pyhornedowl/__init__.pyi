...
class PyIndexedOntology:
    ...
    def add_component(self, component: model.Component, annotations: Optional[Set[model.Annotation]]=None) -> None:
        """
        Adds an axiom to the ontology with optional annotations.
        """
        ...

    def add_axiom(self, ax: model.Component, annotations: Optional[Set[model.Annotation]]=None) -> None:
        """
